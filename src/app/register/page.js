...
export default function Register() {
    ...
    const [userRole, setUserRole] = useState('admin_tenant');
    ...
    return (
        <section className="grid text-center h-svh md:h-full items-center p-12 bg-light-blue-200">
          ...
          <Card className="pb-10">
            <CardBody>
              ...
              <Typography variant="paragraph" className="mb-10 text-gray-600 font-normal ">
                Email dan Password  dibutuhkan untuk login ke Portal Enqoe.
              </Typography>
